...
**Cloud Foundry** provides a marketplace where administrators can enable certain services to be available to developers/operators. These services are called *Managed services*, in contrast to *User-provided services*.
...
> The **Cloud Foundry** manifest file allows us to define multiple applications in a single file
...
##Deploying without Spring Cloud Services
  ...
  If Spring Cloud Services are not available, you should have pushed an instance of the [discovery service](https://github.com/dpinto-pivotal/cf-SpringBootTrader-extras) to the cloud and you should already have a *User-provided service*.
...
![Bootstrap Trader](/docs/springtrader.png)
